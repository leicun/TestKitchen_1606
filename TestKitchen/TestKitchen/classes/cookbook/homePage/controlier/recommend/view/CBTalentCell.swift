...
class CBTalentCell: UITableViewCell {
    ...
    class func creareTalentCellFor(tableView:UITableView, atIndexPath indexPath: NSIndexPath, withListModel listModel: CBRecommendWidgetListModel)->CBTalentCell{
